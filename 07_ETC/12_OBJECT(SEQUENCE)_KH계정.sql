...
/*
    ...
    [INCREMENT BY 숫자]               -- 몇 씩 증가 시킬건지 (기본값 1)
    [MAXVALUE 숫자]                   -- 최대값 지정(기본값 무한이라고 생각합시다)
...
-- 왜냐면 마지막으로 성공적으로 수행된 NEXTVAL 값이기 때문에
...
-- MAXVALUE를 310까지 줬기 때문에 범위 초과로 오류 발생
SELECT SEQ_EMPNO.CURRVAL FROM DUAL;

/*
    3. SEQUENCE 구조 변경 (생성할 때와 같은 상세표현식)
    ALTER SEQUENCE 시퀀스명
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, SAL_LEVEL, HIRE_DATE)
VALUES (SEQ_EID.NEXTVAL, '강계순', '222222-2222222', 'J6', 'S1', SYSDATE);
